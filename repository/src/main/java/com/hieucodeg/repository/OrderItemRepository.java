...
public interface OrderItemRepository extends JpaRepository<OrderItem, Long> {
    ...
    @Query("SELECT NEW com.hieucodeg.domain.dto.orderItem.OrderItemDTO (" +
                "oi.id, " +
                "oi.size, " +
                "oi.price, " +
                "oi.quantity, " +
    ...
    @Query("SELECT NEW com.hieucodeg.domain.dto.orderItem.OrderItemResponseDTO (" +
                "oi.id, " +
                "oi.size, " +
                "oi.price, " +
                "oi.quantity, " +
    ...
    @Query("SELECT NEW com.hieucodeg.domain.dto.orderItem.OrderItemKitchenDTO (" +
                "pd.id, " +
                "pd.title, " +
                "oi.size, " +
                "SUM(oi.quantity), " +
    ...
    @Query("SELECT NEW com.hieucodeg.domain.dto.orderItem.OrderItemKitchenTableDTO (" +
                "oi.id, " +
                "tb.name, " +
                "pd.id, " +
                "pd.title, " +
    ...
    @Query("SELECT NEW com.hieucodeg.domain.dto.report.ReportProductDTO (" +
            "pd.title, " +
