...
import com.hieucodeg.domain.dto.order.OrderCountCurrentMonthDTO;
import com.hieucodeg.domain.dto.order.OrderDTO;
...
public interface OrderRepository extends JpaRepository<Order, Long> {
    ...
    @Query("SELECT NEW com.hieucodeg.domain.dto.order.OrderDTO (" +
            "od.id, " +
            "od.totalAmount, " +
            "od.orderStatus, " +
            "od.table, " +
    ...
    @Query("SELECT NEW com.hieucodeg.domain.dto.report.ReportYearDTO (" +
            "MONTH(od.createdAt), " +
            "sum(od.totalAmount) " +
            ") " +
            "FROM Order AS od " +
    ...
    @Query("SELECT NEW com.hieucodeg.domain.dto.report.ReportDTO (" +
            "sum(od.totalAmount) " +
            ") " +
            "FROM Order AS od " +
    ...
    @Query("SELECT NEW com.hieucodeg.domain.dto.report.ReportDayToDayDTO (" +
    ...
    @Query("SELECT NEW com.hieucodeg.domain.dto.order.OrderCountCurrentMonthDTO (" +
            "count(od.id) " +
            ") " +
            "FROM Order AS od " +
